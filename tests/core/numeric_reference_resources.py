...
from apsgo_scheduler.core._numeric_rules import NumericRuleKind, numeric_rows_prohibited_profile, numeric_edge_allowed
from apsgo_scheduler.core._numeric_state import NumericDynamicNode, NumericSplitGroup, NumericTask, OK, extend_numeric_task
from apsgo_scheduler.core._numeric_units import NumericValueError, checked_product, checked_sum
...
def _prototype_edge_mask(task, program, left_rows, right_rows):
    ...
    from apsgo_scheduler.core._numeric_kernel import task_columns, rule_tables, edge_matrix_kernel, OK
